...
namespace FCA
{
    public class FCA
    {
            ...
            LinkedList<string> res, LinkedList<string> details)
        {
            ...
            //unblocked
            details.AddLast(String.Format("{0} {1} {2} {3} {4} {5} {6} {22:0.000} {23} {24} {25} {26} {27}", model, method, m, n, reactions_unblocked, reactions_frev, couples, (time_efca - time_start).TotalSeconds, (time_unblocked - time_start).TotalSeconds, (time_frev - time_unblocked).TotalSeconds, (time_couples - time_frev).TotalSeconds, (time_efca - time_couples).TotalSeconds, lps, lps_unblocked, lps_frev, lps_couples, lps_efca, wits, wits_unblocked, wits_frev, wits_couples, wits_efca, time_start, -1, lps_unblocked, lps_unblocked, wits_unblocked, wits_unblocked));
            //couples
            int lps_total = lps_unblocked;
            int wits_total = wits_unblocked;
            int temp_i = 0;
            for (int i = 0; i < n; ++i)
